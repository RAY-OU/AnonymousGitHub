...
**Full GradHarmon** (4th column) combines both: natural colors with rich texture detail across all examples. Table 2 confirms the combination achieves the best results on every metric. Notably, neither component alters spatial layout or composition, preserving output diversity.
